...
export const homeFaqItems: Faq[] = [
  ...
  },
  {
    ...
    answer: `No special license is required! You only need a valid driver's license. The Polaris Slingshot uses ${vehicleSpec.transmissionShort.replace(/^AutoDrive — /, "AutoDrive — ")}, making it as easy to drive as a car. However, all riders must be approved by our insurance company before driving.`,
  },
  {
